...
df = pd.read_excel('/home/yennifer-gomez/ailab-olivia-faqs/data/evaluacion/AC_test.xlsx')
...
output_file_path = '/home/yennifer-gomez/ailab-olivia-faqs/data/evaluacion/AC_test_ailab_gemflash.xlsx'
